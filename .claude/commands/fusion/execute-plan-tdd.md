...
1. summarize the slices completed in this run
2. list the focused tests and broader checks run
3. name the next slice to resume from
4. note any remaining risks or blockers
5. tell the user to rerun `/fusion:execute-plan-tdd` for the next slice budget
...
Next step:
1. Run /fusion:execute-plan-tdd again for the next slice budget
```
