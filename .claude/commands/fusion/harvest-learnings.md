...
## Relationship To `/trellis:update-spec`

Use `/fusion:harvest-learnings` when you want a task-end synthesis pass.

Use `/trellis:update-spec` when:
...
Next steps:
1. Run /trellis:check
2. Run /trellis:finish-work
3. After human testing and commit, run /trellis:record-session
```
